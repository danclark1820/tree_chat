...
defmodule TreeChat.Chat do
  ...
  def list_messages(chat = %Chat{}, message_id: message_id) do
    ...
    |> Repo.paginate(before: cursor_for_message, cursor_fields: [:inserted_at, :id], sort_direction: :desc, limit: 4)

    messages
    |> Repo.paginate(after: cursor_including_messages.metadata.after, cursor_fields: [:inserted_at, :id], sort_direction: :desc, limit: 4)
  end
